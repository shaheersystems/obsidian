    ...
    <>
      <div>
        ...
        <div className="lg:pl-72 ">
          <div className="sticky top-0 z-40 flex items-center h-16 px-4 text-white bg-gray-900 border-b border-gray-200 shadow-sm shrink-0 gap-x-4 sm:gap-x-6 sm:px-6 lg:px-8">
            <button
              type="button"
                ...
                <Menu as="div" className="relative">
                  <Menu.Button className="-m-1.5 flex items-center p-1.5">
                    ...
                    <span className="hidden lg:flex lg:items-center">
                      ...
                      <ChevronDownIcon
                        className="w-5 h-5 ml-2 text-gray-200"
                        aria-hidden="true"
                      />
                    </span>
                  </Menu.Button>
