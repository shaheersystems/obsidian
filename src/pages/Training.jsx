                            ...
                            <div className="p-4 border border-slate-300 ">
                                ...
                                <fieldset className="mb-[15px] w-full flex flex-col justify-start pt-3 p-15">
                                    ...
                                    <div className="flex flex-row justify-start items-start">
                                        ...
                                        <button onClick={addNodePool} className="text-blue-600 text-start font-bold text-[12px] hover:bg-slate-200  p-2">ADD</button>
                                        <button onClick={removeNodePool} className={`${nodedivs.length == 0 ? "hidden" : ""} text-blue-600 text-start font-bold text-[12px] hover:bg-slate-200 p-2`}>REMOVE</button>
                                    </div>
                                </fieldset>
