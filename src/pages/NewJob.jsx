...
function NewJob() {
  ...
  const addS3storagedivs = () => {
    setS3storagedivs((prevDivs) => [
      ...prevDivs,
      <div className="flex flex-row flex-wrap pt-3 border border-gray-200 mb-2 md:p-4">
        ...
        <fieldset className="p-3 mb-[10px] w-full flex flex-col justify-start ">
          <label className="text-[13px] leading-none mb-2.5 text-violet12 block" htmlFor="endpointURL">
            Enpoint URL
          </label>
          <input
            className="grow shrink-0 rounded px-2.5 text-[12px] leading-none text-violet11 shadow-[0_0_0_1px] shadow-violet7 h-[24px] focus:shadow-[0_0_0_2px] focus:shadow-violet8 outline-none"
          ...
          <Tabs.Content value="tabInteractive" className="md:w-9/12 w-full m-auto p-6 pt-10 md:p-11 ">
            ...
            <div>
              ...
              >
                ...
                <Accordion.Item className="mb-2 md:w-9/12 w-full" value="item-4">
                  <Accordion.Trigger className="w-full ">
                    <div className="flex flex-row justify-start">
                      <div className="pr-2">
                        <ChevronDownIcon className="w-5 h-5" />
                    ...
                    <div className="p-4 border border-slate-400 ">
                      ...
                      <fieldset className="mb-[15px] w-full flex flex-col justify-start pt-3  p-15">
                        ...
                        <div className="flex flex-row justify-start items-start">
                          ...
                          <button onClick={addNodePool} className="text-blue-600 text-start font-bold text-[12px] hover:bg-slate-200 w-11 mt-5 p-2">ADD</button>
                          <button onClick={removeNodePool} className={`${nodedivs.length == 0 ? "hidden" : ""} text-blue-600 text-start font-bold text-[12px] hover:bg-slate-200 w-11 mt-5 p-2`}>REMOVE</button>
                        </div>
                      </fieldset>
